...
@Provider
class GameGatewayConnectionTimeoutExceptionMapper : ExceptionMapper<GameGatewayConnectionTimeoutException> {
    override fun toResponse(exception: GameGatewayConnectionTimeoutException): Response =
        Response
